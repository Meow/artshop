...
export default function CatalogueMlpSFW() {
  return (
    <div className="artists">
      ...
      <Artist name={'JedaySkayVoker'} artistid={'jedayskayvoker'} filekey={'jnp'} keymax={42} showid={true} />
      <Artist name={'Nevobaster'} artistid={'nevobaster'} filekey={'nnp'} keymax={27} showid={true} />
